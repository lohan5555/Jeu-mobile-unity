...
public class FireAttackType
{
    ...
    [Header("Param�tres de l'attaque")]
...
public class FireAttackManager : MonoBehaviour
{
    ...
    public AudioClip combatMusic;       // clip � jouer
    ...
    void Awake()
    {
        // R�cup�ration du UIDocument et de ButtonTalk
    ...
    private void SpawnAttack(FireAttackType attack)
    {
        ...
        {
            Debug.LogWarning($"Aucun spawn point d�fini pour l'attaque {attack.attackName}");
            return;
        }
    ...
    private void SpawnFireZone()
    {
        ...
        {
            Debug.LogWarning("Aucun spawn point d�fini pour la zone de feu !");
            return;
        }
